        ...
        <div className="max-w-[600px] flex flex-col items-center justify-center p-5 gap-3 text-[12px]">
            ...
            <div>
                <p className="text-[#cacaca] text-center">
                    Disney+ es un servicio por suscripción de pago, su contenido está sujeto a <br/>disponibilidad.
                    El servicio Disney+ es comercializado por The Walt Disney<br/> Company (Argentina) S.A., Tucumán 1, Piso 4º (C1049AAA) 
                    Ciudad Autónoma de <br/>Buenos Aires, Argentina y número de CUIT 30-63984459-1.
                </p>
            </div>
            <div>
